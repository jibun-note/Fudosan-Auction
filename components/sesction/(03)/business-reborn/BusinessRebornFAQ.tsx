				...
				>
					{businessRebornFaqItems.map((item, i) => (
						...
						>
							...
							<AccordionContent className="overflow-y-auto border-t whitespace-pre-wrap border-gray-100 px-4 pb-3 pt-0 text-sm leading-relaxed text-gray-600 md:px-5 md:pb-4 md:text-lg">
								{item.answer}
							</AccordionContent>
						</AccordionItem>
					))}
